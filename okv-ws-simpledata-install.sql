...
--
-- Table structure for table `ws_b_blog`
--

CREATE TABLE IF NOT EXISTS `ws_b_blog` (
  `blog_id` int(11) NOT NULL AUTO_INCREMENT,
  `blog_title` varchar(255) DEFAULT NULL,
  `blog_content` text,
  `blog_author` int(11) DEFAULT NULL COMMENT 'refer to account_id',
  `blog_date` date DEFAULT NULL,
  PRIMARY KEY (`blog_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=11 ;

--
-- Dumping data for table `ws_b_blog`
--

INSERT INTO `ws_b_blog` (`blog_id`, `blog_title`, `blog_content`, `blog_author`, `blog_date`) VALUES
(1, 'test1', 'test', 1, '2012-02-27'),
(2, 'test2', 'test', 1, '2012-02-27'),
(3, 'test3', 'test', 1, '2012-02-27'),
(4, 'test4', 'test', 1, '2012-02-27'),
(5, 'test5', 'test5', 1, '2012-02-27'),
(7, 'test7', 'test', 1, '2012-02-27'),
(8, 'test8', 'test', 1, '2012-02-27'),
(9, 'test9', 'test', 1, '2012-02-27'),
(10, 'test10', 'test10', 1, '2012-02-27');
