...
$config['email_sender'] = 'sender@domain.tld'; // default sender use in programs
$config['email_sender_name'] = ''; // default sender name
/*------------------------------------------------------*/
$config['protocol'] = 'smtp'; // mail, sendmail, or smtp
$config['smtp_host'] = 'mail.domain.tld';
$config['smtp_user'] = 'email@domain.tld';// for smtp auth->send.
