		...
		<div class="page_container">
			<div class="page_login">
				...
				<div class="requirement_check">
					...
					<span>
						<object width="16" height="16" data="<?php echo base_url(); ?>client/images/yes.swf" type="application/x-shockwave-flash" style="margin-left:0px; position:absolute; z-index:2;">
