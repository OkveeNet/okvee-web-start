...
<div class="commands">
	[<?php echo anchor( current_url().'/getnew', lang( 'account_fetch_new_permissions' ) ); ?>] [<?php echo anchor(current_url().'/reset', lang( 'account_clear_settings' ), array( 'id' => 'reset_permission' ) ); ?>]
</div><!--.commands-->
...
<?php echo form_open( current_url().'/save' ); ?>
	...
	<table class="list_item">
		...
		<tbody>
			...
			<tr>
				<td><strong><?php echo lang( $item['permission_page'] ); ?></strong> 
					<a href="<?php echo current_url(); ?>/reset_one?perm_page=<?php echo $item['permission_page']; ?>"><img src="<?php echo base_url(); ?>client/images/reset.png" alt="<?php echo lang( 'account_reset' ); ?>" title="<?php echo lang( 'account_reset' ); ?>" /></a>
					<a href="<?php echo current_url(); ?>/remove_one?perm_page=<?php echo $item['permission_page']; ?>"><img src="<?php echo base_url(); ?>client/images/remove.png" alt="<?php echo lang( 'account_delete' ); ?>" title="<?php echo lang( 'account_delete' ); ?>" /></a>
				</td>
				<td class="no_padding">
