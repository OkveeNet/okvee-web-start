...
class modules_model extends CI_Model {
	...
	/**
	 * fetch_permissions_dir
	 * @return array 
	 */
	function fetch_permissions_dir() {
	...
	/**
	 * getnew
	 * fetch new permission page
	 * @return boolean
	 */
	function getnew() {
		$permission_array = $this->fetch_permissions_dir();
		// compact db
		$this->db->query( 'ALTER TABLE `' . $this->db->dbprefix( 'account_level_permission' ) . '` AUTO_INCREMENT =1' );
		// add new permissions
